...
public class EventService(IEventRepository repo)
{
    ...
    private static EventResponseDto Map(Models.Event.Event e) => new() // Entity -> DTO
    {
        Id = e.Id,
        Title = e.Title,
    ...
    private static Models.Event.Event ToEntity(CreateEventDto dto, EventOwnerType ownerType, int ownerId) => new() //DTO -> Entity (create)
    {
        OwnerType = ownerType,
        OwnerId = ownerId,
    ...
    private static Models.Event.Event ToEntity(UpdateEventDto dto, EventOwnerType ownerType, int ownerId, int eventId) => new() //DTO -> Entity (update)
    {
        Id = eventId,
        OwnerType = ownerType,
        OwnerId = ownerId,
