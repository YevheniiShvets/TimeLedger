...
public class EventOccurrenceService(IEventRepository eventRepository, IRecurrenceService recurrenceService)
{
    ...
    private static EventResponseDto MapEvent(Models.Event.Event e, DateTime startTime, DateTime endTime) => new()
    {
        Id = e.Id,
        Title = e.Title,
